...
#sigma := 1 - (9*x^2*(1 + x))/20;
#alpha := 1/27*(-9 + (21141 - 1458*(210)^(1/2))^(1/3) + 9*(29 + 2*(210)^(1/2))^(1/3));
#sigma := -(x - alpha);
#g := -(x+1)*x*(x-1)^2;
#checkWeifeng(sigma, [g], x, "??");

#checkWeifeng(x+1, [-x*(x-2)], x, "??");

#tau := 2 + (3*x)/4 - (101*(2 + x)^2)/400 + (3*(2 + x)^4*(1/4 - (3*x)/4 + (101*x*(1 + x))/400)*(2 - (3*x*(1 + x)*(2 + x)^2)/320 + (1 - (3*x*(1 + x)*(2 + x)^2)/320)^2 + (1 - (3*x*(1 + x)*(2 + x)^2)/320)^3 + (1 - (3*x*(1 + x)*(2 + x)^2)/320)^4 + (1 - (3*x*(1 + x)*(2 + x)^2)/320)^5))/320;
#g := -(x+2)^2*x*(x-2);

#tau := 200 - 3*x^2 + 9*x^3 - 6*x^4;
...
#checkWeifeng(sigma, [g1], x, "??");
#checkWeifeng(tau, [g1], x, "??");

#tau := 1/8 - (353*(-1 + x)*(1 + x))/3200 + (3*(-1 + x)^2*(1 + x)^2*((353*(-3 \
#- x)*(-3 + x)*x^2)/3200 + (-8 + x^2)/8)*(2 - (3*(-3 - x)*(-3 + x)*(-1 \
#+ x)*x^2*(1 + x))/271 + (1 - (3*(-3 - x)*(-3 + x)*(-1 + x)*x^2*(1 + \
#x))/271)^2 + (1 - (3*(-3 - x)*(-3 + x)*(-1 + x)*x^2*(1 + x))/271)^3 + \
#(1 - (3*(-3 - x)*(-3 + x)*(-1 + x)*x^2*(1 + x))/271)^4 + (1 - (3*(-3 \
#- x)*(-3 + x)*(-1 + x)*x^2*(1 + x))/271)^5 + (1 - (3*(-3 - x)*(-3 + \
#x)*(-1 + x)*x^2*(1 + x))/271)^6 + (1 - (3*(-3 - x)*(-3 + x)*(-1 + \
#x)*x^2*(1 + x))/271)^7 + (1 - (3*(-3 - x)*(-3 + x)*(-1 + x)*x^2*(1 + \
#x))/271)^8 + (1 - (3*(-3 - x)*(-3 + x)*(-1 + x)*x^2*(1 + x))/271)^9 + \
#(1 - (3*(-3 - x)*(-3 + x)*(-1 + x)*x^2*(1 + x))/271)^10 + (1 - (3*(-3 \
#- x)*(-3 + x)*(-1 + x)*x^2*(1 + x))/271)^11 + (1 - (3*(-3 - x)*(-3 + \
#x)*(-1 + x)*x^2*(1 + x))/271)^12 + (1 - (3*(-3 - x)*(-3 + x)*(-1 + \
#x)*x^2*(1 + x))/271)^13 + (1 - (3*(-3 - x)*(-3 + x)*(-1 + x)*x^2*(1 + \
#x))/271)^14 + (1 - (3*(-3 - x)*(-3 + x)*(-1 + x)*x^2*(1 + x))/271)^15 \
#+ (1 - (3*(-3 - x)*(-3 + x)*(-1 + x)*x^2*(1 + x))/271)^16 + (1 - \
#(3*(-3 - x)*(-3 + x)*(-1 + x)*x^2*(1 + x))/271)^17 + (1 - (3*(-3 - \
#x)*(-3 + x)*(-1 + x)*x^2*(1 + x))/271)^18 + (1 - (3*(-3 - x)*(-3 + \
#x)*(-1 + x)*x^2*(1 + x))/271)^19 + (1 - (3*(-3 - x)*(-3 + x)*(-1 + \
#x)*x^2*(1 + x))/271)^20 + (1 - (3*(-3 - x)*(-3 + x)*(-1 + x)*x^2*(1 + \
#x))/271)^21 + (1 - (3*(-3 - x)*(-3 + x)*(-1 + x)*x^2*(1 + x))/271)^22 \
#+ (1 - (3*(-3 - x)*(-3 + x)*(-1 + x)*x^2*(1 + x))/271)^23 + (1 - \
#(3*(-3 - x)*(-3 + x)*(-1 + x)*x^2*(1 + x))/271)^24 + (1 - (3*(-3 - \
#x)*(-3 + x)*(-1 + x)*x^2*(1 + x))/271)^25 + (1 - (3*(-3 - x)*(-3 + \
#x)*(-1 + x)*x^2*(1 + x))/271)^26 + (1 - (3*(-3 - x)*(-3 + x)*(-1 + \
#x)*x^2*(1 + x))/271)^27 + (1 - (3*(-3 - x)*(-3 + x)*(-1 + x)*x^2*(1 + \
#x))/271)^28 + (1 - (3*(-3 - x)*(-3 + x)*(-1 + x)*x^2*(1 + x))/271)^29 \
#+ (1 - (3*(-3 - x)*(-3 + x)*(-1 + x)*x^2*(1 + x))/271)^30 + (1 - \
#(3*(-3 - x)*(-3 + x)*(-1 + x)*x^2*(1 + x))/271)^31 + (1 - (3*(-3 - \
#x)*(-3 + x)*(-1 + x)*x^2*(1 + x))/271)^32 + (1 - (3*(-3 - x)*(-3 + \
#x)*(-1 + x)*x^2*(1 + x))/271)^33 + (1 - (3*(-3 - x)*(-3 + x)*(-1 + \
#x)*x^2*(1 + x))/271)^34 + (1 - (3*(-3 - x)*(-3 + x)*(-1 + x)*x^2*(1 + \
#x))/271)^35 + (1 - (3*(-3 - x)*(-3 + x)*(-1 + x)*x^2*(1 + x))/271)^36 \
#+ (1 - (3*(-3 - x)*(-3 + x)*(-1 + x)*x^2*(1 + x))/271)^37))/271;
#HfG := [x + 3, (x + 1)*x, (x + 1/2)*(x - 1/2), x*(x - 1), -(x-3)];
#poly := -720 + (2861*x^2)/2 + (57*x^4)/2 - 19*x^6;
#poly := -144000000/100001 + (142101440*x^2)/100001 + (3800019*x^4)/100001 - 19*x^6;

#poly := -(-1440 - 19*x^2 + 19*x^4);
#checkWeifeng(poly, [x + 3, -(x - 3)], x, "PASS");

#poly := (-2/3 + x^2);
#HfG := [x + 3, (x + 1)*x, (x + 1/2)*(x - 1/2), x*(x - 1), -(x - 3)];

#poly := (-2/3 + x^2)*(-(-1440 - 19*x^2 + 19*x^4));
#checkWeifeng(poly, HfG, x, "??");
...
#g2 := -(x+2)*(x+1)*(x-2)*(x-3);
#checkWeifeng(-(x-5), [g2], x, "??");

#g1 := (x + 1)*(x - 2)*(x - 4);
#g2 := -(x - 1);
#checkWeifeng(-(x-16), [g1, g2], x, "??");

#g1 := x + 5;
#g2 := -(x + 2)*(x + 1)*(x - 2)*(x - 3);
#g3 := (x + 1)*(x - 4);
#checkWeifeng(-(x-6), [g1, g2, g3], x, "??");

#tau:=41/12096*x^2 - 257/3024 + 239/625865885568*(41*x^2 + 79)^2*(x + 6)^2*(x - 6)^2;
#g1 := (-(41*x^2 + 79)/216*(x + 6)*(x - 6))*(x + 3)*(x - 3);
#checkWeifeng(tau, [g1], x, "??");

#g1 := (x+1)*x^3*(x-1)^6*(x-2)^3;
#g2 := x*(x-1);
#g3 := -(x-1/2)*(x-1)^2*(x-2)^4;
#g4 := -(x+1)^3*x^2*(x-2)^3;
